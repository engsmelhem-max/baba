...
// 🔄 التعديل الجديد: العودة إلى صفحة الزر الميكانيكي فوراً مع الاحتفاظ بالبيانات المدخلة
function resetToStep1() {
    textRecognitionResult = ""; 
    audioChunks = [];
    
    // إعادة تعيين نص الحالة تحت الزر
    const statusTextEl = document.getElementById('status-text');
    if (statusTextEl) statusTextEl.innerText = "اضغطي باستمرار للطلب...";

    // الانتقال المباشر لصفحة الزر الميكانيكي (الخطوة 2) دون مسح البيانات أو الهاتف
